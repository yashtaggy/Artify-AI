...
// 🔥 forwardRef so parent can access the element
export const ProvenanceCard = forwardRef<HTMLDivElement, ProvenanceCardProps>(
  ({ productName, story, imageUrl }, ref) => {
    return (
      <div ref={ref}>
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="flex items-center justify-between text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span className="font-headline text-lg">ArtifyAI</span>
              </div>
...
ProvenanceCard.displayName = 'ProvenanceCard';