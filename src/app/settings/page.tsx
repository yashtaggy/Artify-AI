...
import { ThemeSwitcher } from '@/components/ui/ThemeSwitcher'; // <-- NEW IMPORT
import {
  updatePassword,
  onAuthStateChanged,
  EmailAuthProvider,
...
export default function SettingsPage() {
  ...
  // Removed local themeMode state, as ThemeSwitcher handles this globally.
  ...
  const handleChangePassword = async () => {
    ...
    if (isAnonymous || !isEmailProvider) {
      toast({
